...
angular.module('bahmni.common.patientSearch')
    .controller('PatientsListController', ['$scope', '$window', '$http', '$q', 'patientService', '$rootScope', 'appService', 'spinner',
        '$stateParams', '$bahmniCookieStore', 'printer', 'configurationService',
        function ($scope, $window, $http, $q, patientService, $rootScope, appService, spinner, $stateParams, $bahmniCookieStore, printer, configurationService) {
            ...
            $q.all([getUserRole()]).then(function (response) {
                ...
                var roleList = roles.map(role => {
                    return role.name;
                });
                $window.localStorage.setItem('role', roleList);
            });
