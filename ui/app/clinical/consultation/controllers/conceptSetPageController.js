...
angular.module('bahmni.clinical')
    .controller('ConceptSetPageController', ['$scope', '$window', 'appService', '$rootScope', '$stateParams', 'conceptSetService',
        'clinicalAppConfigService', 'messagingService', 'configurations', '$state', 'spinner',
        'contextChangeHandler', '$q', '$translate', 'formService',
        function ($scope, $window, appService, $rootScope, $stateParams, conceptSetService,
            clinicalAppConfigService, messagingService, configurations, $state, spinner,
            contextChangeHandler, $q, $translate, formService) {
